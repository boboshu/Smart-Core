...
namespace Smart.Evaluator
{
    ...
    public class Scanner
    {
        ...
        private static readonly List<TokenType> Tokens = new List<TokenType>();
        private static readonly List<TokenType> SkipList = new List<TokenType>(); // tokens to be skipped
        public static readonly Dictionary<TokenType, Regex> Patterns = new Dictionary<TokenType, Regex>();
