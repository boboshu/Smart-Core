...
namespace Smart.Evaluator
{
    public class Context
    {
        ...
        public static Context Default => defaultContext ?? (defaultContext = new Context());
        ...
        /// </summary>
        public int CurrentStackSize => inScope.Count;

        public Variables CurrentScope => inScope.Count <= 0 ? null : inScope[inScope.Count-1];
        ...
        public Variables PopScope()
        {
            ...
            var vars = inScope[inScope.Count-1];
